...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: stock shadcn sidebar primitive; persists the open/collapsed state to a cookie.
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: stock shadcn sidebar primitive; dependency list left as shipped.
